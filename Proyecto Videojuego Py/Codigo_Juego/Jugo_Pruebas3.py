...
fondo = Image.open('Proyecto Videojuego Py\imagenes\fondo_banderas.jpg')
fondo.show()
...
Label(ventana, text="4 Paises Una Bandera", fg="medium blue", font=("Arial",50)).grid(pady=5, row=0, column=2, sticky=S+N+E+W) 
