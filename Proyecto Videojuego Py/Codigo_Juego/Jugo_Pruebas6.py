...
def America():
    ...
    paises = ["Antigua y Barbuba", "Argentina", "Bahamas", "Barbados", "Belice", "Bolivia", "Brasil", "Canada", "Chile", "Colombia", "Costa Rica", "Cuba", "Dominica", "Ecuador", "EEUU", "El Salvador", "Granada", "Guatemala", "Guyana", "Haiti", "Hondures", "Jamaica", "Mexico", "Nicaragua", "Panama", "Paraguay", "Peru", "Puerto Rico", "Republica Dominicana", "San Cristobal y Nieves", "San Vicente y las Granadinas", "Snata Lucia", "Surinam", "Trinidad y Tobago", "Uruguay", "Venezuela"]

    texto = paises[num[0]-1]
    btn_Opcion1 = Button(ventana_America, text=texto, width=35, height=10)
    btn_Opcion1.place(x=30, y=450)

    texto = paises[num[1]-1]
    btn_Opcion2 = Button(ventana_America, text=texto, width=35, height=10)
    btn_Opcion2.place(x=320, y=450)

    texto = paises[num[2]-1]
    btn_Opcion3 = Button(ventana_America, text=texto, width=35, height=10)
    btn_Opcion3.place(x=610, y=450)

    texto = paises[num[3]-1]
    btn_Opcion4 = Button(ventana_America, text=texto, width=35, height=10)
    btn_Opcion4.place(x=900, y=450)
...
def Asia():
    ...
    texto = paises[num[0]-1]
    btn_Opcion1 = Button(ventana_Asia, text=texto, width=35, height=10)
    btn_Opcion1.place(x=30, y=450)

    texto = paises[num[1]-1]
    btn_Opcion2 = Button(ventana_Asia, text=texto, width=35, height=10)
    btn_Opcion2.place(x=320, y=450)

    texto = paises[num[2]-1]
    btn_Opcion3 = Button(ventana_Asia, text=texto, width=35, height=10)
    btn_Opcion3.place(x=610, y=450)

    texto = paises[num[3]-1]
    btn_Opcion4 = Button(ventana_Asia, text=texto, width=35, height=10)
    btn_Opcion4.place(x=900, y=450)
...
def Europa():
    ...
    texto = paises[num[0]-1]
    btn_Opcion1 = Button(ventana_Europa, text=texto, width=35, height=10)
    btn_Opcion1.place(x=30, y=450)

    texto = paises[num[1]-1]
    btn_Opcion2 = Button(ventana_Europa, text=texto, width=35, height=10)
    btn_Opcion2.place(x=320, y=450)

    texto = paises[num[2]-1]
    btn_Opcion3 = Button(ventana_Europa, text=texto, width=35, height=10)
    btn_Opcion3.place(x=610, y=450)

    texto = paises[num[3]-1]
    btn_Opcion4 = Button(ventana_Europa, text=texto, width=35, height=10)
    btn_Opcion4.place(x=900, y=450)
